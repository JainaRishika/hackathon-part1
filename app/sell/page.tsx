...
export default function SellPage() {
  ...
  const onSubmit = async (values: z.infer<typeof sellFormSchema>) => {
    console.log('Form values:', values);
    console.log('Cover image:', coverImage);
    // Here you would typically upload the image and submit the form to your API
  };
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Textarea 
                          {...field}
                          placeholder="Describe the condition and any additional details about the book"
                        />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
